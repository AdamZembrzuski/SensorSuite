/*
 * error_service.c — AZSensorSuite firmware, error reporting
 *
...
static volatile fatal_code_t s_fatal_code = FATAL_KERNEL;

/* Blink frequency encodes the fault type — readable with a stopwatch */
static uint32_t half_period_us_for_code(fatal_code_t code)
{
    switch (code) {
    case FATAL_GPIO_INIT:      return 500000; /* 1 Hz */
    case FATAL_VL53_INIT:      return 250000; /* 2 Hz */
    case FATAL_VL53_CLEAR_IRQ: return 166667; /* 3 Hz */
    case FATAL_ZMS_INIT:       return 125000; /* 4 Hz */
    case FATAL_ZMS_MOUNT:      return 100000; /* 5 Hz */
